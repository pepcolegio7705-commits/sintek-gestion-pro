    ...
    <script>
        $(document).ready(function() {
            $('#tablaMoraServer').DataTable({
                "processing": true,
                "serverSide": true,
                // Llamada al motor AJAX con ruta amigable
                "ajax": "<?= BASE_URL; ?>tesoreria/ajax_mora", 
                "columns": [
                    { "data": "alumno" },
                    { "data": "dni" },
                    { "data": "pagas" },
                ...
                "createdRow": function(row, data, dataIndex) {
                    // Si el motor detecta mora crítica, pintamos la fila de rojo suave
                    if (data.mora_critica === true) {
