...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="../admin/public/img/logo.png">
 ...
 //include '../ajax/asistencia.php' ?>
  ...
  <div class="lockscreen-item">
    ...
    <div class="lockscreen-image">
      <img src="../admin/files/escuela/logo.png" alt="User Image">
    </div>
    <!-- /.lockscreen-image -->
