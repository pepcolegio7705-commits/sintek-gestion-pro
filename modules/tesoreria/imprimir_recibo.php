<?php
/**
 * GENERADOR DE RECIBOS DE HABERES PRO - STAFF (SINTEK GESTIÓN)
 * Diseño: Oficio / Legal - Estandarizado con Profesores
...
class PDF extends FPDF {
    ...
    // FUNCIÓN DE DIBUJO ESTRUCTURAL (DISEÑO LEGAL)
    function Recibo($y, $tipo_copia, $liq, $terceros, $img_qr, $inst, $huella, $texto_marca, $color_marca) {
        ...
        $this->Fila("001", "Sueldo Basico Administrativo", $basico, 0);
...
$pdf->Output('I', 'Recibo_Staff_' . ($liq['legajo'] ?: 'Haberes') . '.pdf');