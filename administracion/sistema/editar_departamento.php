    ...
    include ("config.php");
      ...
      if(isset($_POST['btnEditar'])){
         if(empty($_POST['nombre'])){
            ...
            $id = openssl_decrypt($_POST['dep'],AES,KEY);
            $nombre = $_POST['nombre'];

            $iddepa1 = mysqli_real_escape_string($con,$id);
            $nombre1 = mysqli_real_escape_string($con,$nombre);

            $sentencia = $con->prepare("UPDATE departamentos SET descripcion = ? where id = ?");
            $sentencia->bind_param("si",$nombre1,$iddepa1);
            $sentencia->execute();
               ...
               $mensaje = '<script>
                  ...
                  $mensaje =  '<script>
                                 Swal.fire({
                                   icon: "Error",
                                       title: "Oops...",
                                       text: "Error al actualizar el Departamento - Comuniquese con el administrador!"
                                     });
                                 </script>';
               }
            }
...
<?php
    ...
    include ("../conexion.php");
   //Chequeamos que el id del departamento no venga vacío
   If(empty(openssl_decrypt($_GET['id'],AES,KEY))){
    ...
    $query_consulta = mysqli_query($con, "SELECT id from departamentos where id = $id");
    ...
    $query = mysqli_query($con, "SELECT * from departamentos where id = $id");
...
<html lang="en">
   <head>
      ...
      <link rel="shortcut icon" href="images/icono.png"> Artes Visuales
      <!--[if lt IE 9]>
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                    ...
                    <h2 class="text-center">Editar Información Departamento</h2>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Default Elements -->
                                ...
                                <div class="shadow-lg p-3 m-auto bg-white rounded">
                                    <form action="" method="post" class="">
                                        <div class="form-group row">
                                            <div class="col-md-9">
                                                <input type="hidden" class="form-control" id="id" name="dep" value="<?php echo openssl_encrypt($iddep,AES,KEY);?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12" for="example-email-input">Descripción</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="nombre" value="<?php echo $desc?>" placeholder="Nombre del Departamento">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-6">
                                                <<button type="submit" class="btn btn-success" name="btnEditar"><i class="fa fa-floppy-o" aria-hidden="true"></i> Editar departamento</button>
                                            </div>
                                            <div class="col-6">
                                              <div class="col-6">
                                                 <a class="btn btn-warning" href="lista_departamentos.php"><i class="fa fa-backward" aria-hidden="true"></i> Volver</a>
                                               </div>
                                            </div>
                                        </div>
                                    </form>
