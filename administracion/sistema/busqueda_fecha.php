            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class="content">
                        <!-- Bootstrap Design -->
                        <h2 class="content-heading mb-3 text-center">Listado Asistencias</h2>
                        <hr>
                        <div class="row">
                            <div class="col-md-12">
                                <!-- Default Elements -->
                                        ...
                                        <form action="" method="POST">
                                            <div class="form-group row">
                                                ...
                                                <!--<div class="col-md-4">
                                                    <label for="agente">Agente</label>
                                                        <select class="form-control" id="dni" name="dni">
                                                            ...
                                                            <?php
                                                                ...
                                                                /*$query_ag = mysqli_query($con, "SELECT ayn, dni from docentes");
                                                                while($data_ag=mysqli_fetch_array($query_ag)){
                                                                    $ayn = $data_ag['ayn'];
                                                                    $dni = $data_ag['dni'];
                                                                
                                                            ?>
                                                            <option value="<?php echo $dni?>"><?php echo $ayn?></option>
                                                            <?php
                                                    ...
                                                    <div class="col-md-2">
                                                        <label for="" calss="form-control">Búsqueda</label>
                                                        <button type="submit" class="btn btn-primary btn-sm mb-3 form-control" name="btnBuscar"><i class="fa fa-search" aria-hidden="true"></i> Buscar</button>
                                                    </div>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class="block">
                            <div class="block-content block-content-full">
                                ...
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="tabla">
                                    <thead>
                                        <tr>
                                            <th>Código</th>
                                            <th>Nombre</th>
                                    ...
                                    <?php 
                                            ...
                                            $query = mysqli_query($con,"SELECT a.codigo_persona, d.ayn, a.fecha_hora, a.tipo, a.fecha from asistencia a inner join docentes d on a.codigo_persona = d.dni where fecha between '$from_date' AND '$to_date'");
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $consulta['codigo_persona']?></td>
                                                    <td><?php echo $consulta['ayn']?></td>
                                                    <td><?php echo $consulta['fecha_hora']?></td>
                    ...
                    $(win.document.body)
                        ...
                        .prepend('<div style="margin-left:5%">' +
                                    '<table border=\'1\' cellspacing=0 style="text-align:center; width: 90%;">' +
                                         ...
                                         '<thead>' +
                                            '<tr>' +
                                                '<th colspan=\'2\'><h4>Instituto Educación Superior N° 816 - Tel. 280-4484112 - Rawson Chubut</h4></th>' +
                                                '<th></th>' +
                                            '</tr>' +
                                            '<tr>' +
