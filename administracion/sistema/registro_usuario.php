      ...
      if (!empty($_POST)) {
         ...
         if(empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['usuario']) || empty($_POST['clave']) || empty($_POST['rol'])){
            $mensaje =  '<script>
             ...
             $query = $con->prepare("SELECT * from usuarios where usuario = ? OR correo = ?");
             $query->bind_param("ss",$user1,$email1);
             $query->execute();
             ...
             if ($result > 0) {
               $mensaje =  '<script>
                              ...
                              icon: "error",
                              title: "Oops...",
                              text: "Usuario o correo electrónico ya existen en la base de datos!"
                                 });
                              </script>';
             }else{
               ...
               $rol1 = mysqli_real_escape_string($con,$rol); 
                ...
                $sentencia = $con->prepare("INSERT INTO usuarios(nombre,correo,usuario,clave,rol)VALUES(?,?,?,?,?)");
                $sentencia->bind_param("ssssi",$nombre1,$email1,$user1,$clave1,$rol1);
                $sentencia->execute();
                 ...
                 if($sentencia){
                  ...
                  $mensaje =  '<script>
                                 ...
                                 icon: "Error",
                                 title: "Oops...",
                                 text: "Error al almacenar el Usuario - Comuniquese con el administrador!"
                                       });
                              </script>';
                 }
             }
                            ...
                            <div class="block">
                                ...
                                <div class="shadow-lg p-3 m-auto bg-white rounded">
                                    <form action="" method="post" class="">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-6">
                                                <button type="submit" class="btn btn-success" name="btnGuardar"><i class="fa fa-floppy-o" aria-hidden="true"></i> Crear Usuario</button>
                                            </div>
                                            <div class="col-6">
                                              <div class="col-6">
