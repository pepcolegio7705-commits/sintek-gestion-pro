<?php
   ...
   if(isset($_POST['btnEditar'])){
      if(empty($_POST['nombre'])){
         ...
         $query_update = $con->prepare("UPDATE cargos set nombre = ? where id = ?");
         $query_update->bind_param("si",$nombre1,$idcargo1);
         ...
         if($query_update){
            ...
            $mensaje =  '<script>
                              Swal.fire({
                                 icon: "Error",
                                 title: "Oops...",
                                 text: "Error al actualizar el Cargo - Comuniquese con el administrador!"
                              });
                        </script>';
         }
...
<?php
    ...
    $query_consulta = mysqli_query($con, "SELECT id from cargos where id = $id");
    ...
    $query = mysqli_query($con, "SELECT * from cargos where id = $id");
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <?php echo $alert?>
                    <!-- Bootstrap Design -->
                    <h2 class="text-center">Editar Información Cargos</h2>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Default Elements -->
                                ...
                                <div class="shadow-lg p-3 m-auto bg-white rounded">
                                    <form action="" method="post" class="">
                                        <div class="form-group row">
                                            <!--<label class="col-12" for="example-text-input">Identificación</label>-->
                                            <div class="col-md-9">
                                                <input type="hidden" class="form-control" id="id" name="id" value="<?php echo openssl_encrypt($idcar,AES,KEY)?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12" for="example-email-input">Descripción</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $desc?>" placeholder="Nombre del Cargo">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-6">
                                                <button type="submit" class="btn btn-success" name="btnEditar"><i class="fa fa-floppy-o" aria-hidden="true"></i> Editar Cargo</button>
                                            </div>
                                            <div class="col-6">
                                              <div class="col-6">
                                                 <a class="btn btn-warning" href="listado_cargos.php"><i class="fa fa-backward" aria-hidden="true"></i> Volver</a>
                                               </div>
                                            </div>
                                        </div>
                                    </form>
