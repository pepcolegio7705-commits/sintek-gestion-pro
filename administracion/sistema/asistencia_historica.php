...
<?php
   ...
   $query = mysqli_query($con, "SELECT dni from docentes where dni=$cod");
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <!---------------Listado Asistencia--------------------->
                    <h2 class="text-center">Listado Historico Asistencia: </h2>
                    <hr>
                    <div class="col-6 mb-2">
                        <a class="btn btn-warning" href="lista_asistencia.php"><i class="fa fa-backward" aria-hidden="true"></i> Volver al Listado</a>
                    </div>
                     <div class="container-fluid">
                        <div class="row">
                                ...
                                <table id="tablaAsistencias" class="table table-striped table-bordered table-condensed" style="width:100%" >
                                    ...
                                    <tbody>
                                       <?php 
                                          ...
                                          $query = mysqli_query($con, "SELECT a.idasistencia, a.codigo_persona, d.ayn, a.fecha_hora, a.tipo, a.fecha from asistencia a inner join docentes d on a.codigo_persona=d.dni where a.codigo_persona = $cod order by a.idasistencia DESC ");
                                          while($data=mysqli_fetch_array($query)){

                                       ?>
                                          <tr>
                                             <td><?php echo $data['idasistencia']?></td>
                                             <td><?php echo $data['codigo_persona']?></td>
