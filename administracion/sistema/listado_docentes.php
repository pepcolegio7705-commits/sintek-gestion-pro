         ...
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  ...
                  <div class="col-md-3">
                        <a class="btn btn-success btn-sm text-dark" href="registro_docente.php"><i class="fa fa-floppy-o" aria-hidden="true"></i> Nuevo Docente</a>
                  </div>
                  <hr>
                   <!-- Bootstrap Design -->
                  ...
                  <table class="table" id="tabla">
                     ...
                     <tbody>
                        ...
                        <?php
                              ...
                              $query = mysqli_query($con, "SELECT d.id, d.ayn, d.dni, p.descripcion, c.nombre,d.email from docentes d inner join departamentos p on d.iddepartamento = p.id inner join cargos c on d.idcargo=c.id where d.estatus = 1 order by d.id ASC");
                        ...
                        <tr>
                           ...
                           <td><?php echo $data['ayn']?></td>
                           <td><?php echo $data['dni']?></td>
                           <td><?php echo $data['descripcion']?></td>
                           <td><?php echo $data['nombre']?></td>
                           <td><?php echo $data['email']?></td>
                           <td>
                              <a class="btn btn-primary btn-sm text-black" href="editar_docente.php?id=<?php echo openssl_encrypt($data['id'],AES,KEY)?>"><i class="fa-solid fa-user-pen"></i> Editar</a>
                           </td>
                           <td>
                              <a class="btn btn-danger btn-sm text-black" href="eliminar_confirmar_docente.php?id=<?php echo openssl_encrypt($data['id'],AES,KEY)?>"><i class="fas fa-trash-alt"></i> Eliminar</a>
                           </td>
                        </tr>
                  ...
                  <div class="container-fluid">
                     <div class="footer">
                        <p>CCopyright &copy; <?php echo date("Y");?> JAW Sistemas. Todos los derechos reservados.<br><br>
