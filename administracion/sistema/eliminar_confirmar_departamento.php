<?php
   ...
   if($_SESSION['rol'] != 1 && $_SESSION['rol'] != 2 ){
    ...
    if(isset($_POST['btnEliminar'])){
      ...
      $query_delete = mysqli_query($con, "UPDATE departamentos set estatus = 0 where id = $id1");
      mysqli_close($con);
      if($query_delete){
         $mensaje
          = '<script>
            ...
            $mensaje =  '<script>
                  ...
                  icon: "Error",
                  title: "Oops...",
                  text: "Error al eliminar el Departamento - Comuniquese con el administrador!"
                        });
               </script>';
        }
    }
...
<?php
    ...
    if(empty(openssl_decrypt($_GET['id'],AES,KEY))){ //Validamos que el id no este vacio
      header("Location:lista_departamentos.php");
      mysqli_close($con);
   }
   ...
   $query_consulta = mysqli_query($con, "SELECT id from departamentos where id = $id and estatus=1");
   ...
   $query = mysqli_query($con, "SELECT * from departamentos where id = $id and estatus=1");
                        ...
                        <div class="block block-themed">
                            ...
                            <div class="block-content text-center">
                              ...
                              <div class="">
                                   ...
                                   <p>Departamento: <span><?php echo $desc;?></span></p>

                                   <form method="post" action="">
                                     <input type="hidden" name="id" value="<?php echo openssl_encrypt($iddep,AES,KEY);?>">
                                     <a href="lista_departamentos.php" class="btn btn-success"><i class="fas fa-ban"></i> Cancelar</a>
