            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class="content">
                        <!-- Bootstrap Design -->
                        <h2 class="content-heading mb-3 text-center">Listado Asistencias Por Fecha</h2>
                        <hr>
                        <div class="row">
                            <div class="col-md-12">
                                <!-- Default Elements -->
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="tabla">
                                ...
                                <?php 
                                        if(isset($_POST['btnBuscar'])){
                                            ...
                                            $query = mysqli_query($con,"SELECT a.idasistencia, d.ayn, a.fecha_hora, a.tipo, a.fecha from asistencia a inner join docentes d on a.codigo_persona = d.dni and a.fecha between '$from_date' AND '$to_date'");
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $consulta['idasistencia']?></td>
                    ...
                    $(win.document.body)
                        ...
                        .prepend('<div style="margin-left:5%">' +
                                    '<table border=\'1\' cellspacing=0 style="text-align:center; width: 90%;">' +
                                         ...
                                         '<thead>' +
                                            '<tr>' +
                                                '<th colspan=\'2\'><h4>ESCUELA N° 7705 - "Comunicación" - Tel. 280-4484080 - Rawson Chubut</h4></th>' +
                                                '<th></th>' +
                                            '</tr>' +
                                            '<tr>' +
