         ...
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  ...
                  <div class="col-md-3">
                        <a class="btn btn-success btn-sm text-dark" href="registro_usuario.php"><i class="fa fa-floppy-o" aria-hidden="true"></i> Nuevo Usuario</a>
                  </div>
                  <hr>
                   <!-- Bootstrap Design -->
                  ...
                  <table class="table" id="tabla">
                     ...
                     <tbody>
                        ...
                        <?php
                              ...
                              $query = mysqli_query($con, "SELECT u.idusuario, u.nombre, u.correo, u.usuario, u.clave, r.rol, u.estatus from usuarios u inner join rol r on u.rol = r.idrol where u.estatus = 1 order by u.idusuario ASC");
                        ...
                        <tr>
                           ...
                           <td>
                              <a class="btn btn-primary btn-sm text-black" href="editar_usuario.php?id=<?php echo openssl_encrypt($data['idusuario'],AES,KEY)?>"><i class="fa-solid fa-user-pen"></i> Editar</a>
                           </td>
                           <td>
                              <a class="btn btn-danger btn-sm text-black" name="btnEliminar" href="eliminar_confirmar_usuario.php?id=<?php echo openssl_encrypt($data['idusuario'],AES,KEY)?>"><i class="fas fa-trash-alt"></i> Eliminar</a>
