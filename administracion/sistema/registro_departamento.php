<?php
    ...
    if (isset($_POST['btnNuevo'])) {
        ...
        if(empty($_POST['nombre'])){
            ...
            $query = $con->prepare("INSERT INTO departamentos(descripcion) VALUES(?)");
            $query->bind_param("s",$nombre1);
            $query->execute();
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                ...
                <div class="content m-auto">
                    <?php echo $alert?>
                    <!-- Bootstrap Design -->
                    <h2 class="text-center">Registro Departamento</h2>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Default Elements -->
                                ...
                                <div class="shadow-lg p-3 m-auto bg-white rounded">
                                    <form action="" method="post" class="">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese nombre departamento">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-6">
                                                <button type="submit" class="btn btn-success" name="btnNuevo"><i class="fa fa-floppy-o" aria-hidden="true"></i> Crear Departamento</button>
                                            </div>
                                            <div class="col-6">
                                              <div class="col-6">
