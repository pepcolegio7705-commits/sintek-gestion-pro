         ...
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  ...
                  <div class="col-md-3">
                        <a class="btn btn-success btn-sm text-dark" href="registro_cargo.php"><i class="fa fa-floppy-o" aria-hidden="true"></i> Nuevo Cargo</a>
                  </div>
                  <!-- Bootstrap Design -->
                  <h2 class="text-center">Listado Cargos</h2>
                  <hr>
                  <!-------------------------Listado Usuarios--------------------->
                  <table class="table" id="tabla">
                     ...
                     <tbody>
                        ...
                        <?php
                              ...
                              $query = mysqli_query($con, "SELECT * from cargos where estatus=1 order by id");
                        ...
                        <tr>
                           ...
                           <td>
                              <a class="btn btn-primary btn-sm text-black" href="editar_cargo.php?id=<?php echo openssl_encrypt($data['id'],AES,KEY)?>"><i class="fa-solid fa-user-pen"></i> Editar</a>
                           </td>
                           <td>
                              <a class="btn btn-danger btn-sm text-black" href="eliminar_confirmar_cargo.php?id=<?php echo openssl_encrypt($data['id'],AES,KEY)?>"><i class="fas fa-trash-alt"></i> Eliminar</a>
                           </td>
                        </tr>
