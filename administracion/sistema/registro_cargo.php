<?php
    ...
    if(isset($_POST['btnGuardar'])){
      if(empty($_POST['nombre'])){
         ...
         $query_insert = $con->prepare("INSERT INTO cargos(nombre)values(?)");
         $query_insert->bind_param("s",$nombre1);
         ...
         if($query_insert){
            $mensaje = '<script>
                           Swal.fire({
                                 position: "top-end",
                                 icon: "success",
                                 title: "Departamento almacenado correctamente",
            ...
            Swal.fire({
              icon: "Error",
                  title: "Oops...",
                  text: "Error al almacenar el Departamento - Comuniquese con el administrador!"
                });
            </script>';
         }
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                ...
                <div class="content m-auto">
                    <?php echo $alert?>
                    <!-- Bootstrap Design -->
                    <h2 class="text-center">Registro Cargo</h2>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Default Elements -->
                                ...
                                <div class="shadow-lg p-3 m-auto bg-white rounded">
                                    <form action="" method="post" class="">
                                        <div class="form-group row">
                                            <label class="col-12" for="example-text-input">Nombre Cargo</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese nombre cargo">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-6">
                                                <button type="submit" class="btn btn-success" name="btnGuardar"><i class="fa fa-floppy-o" aria-hidden="true"></i> Crear cargo</button>
                                            </div>
                                            <div class="col-6">
                                              <div class="col-6">
