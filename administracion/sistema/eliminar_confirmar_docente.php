<?php
   ...
   if(isset($_POST['btnEliminar'])){
      ...
      if(empty($_POST['iddoce'])){
          header("Location:listado_docentes.php");
          mysqli_close($con);
          exit;
      }else{
         $iddocente = openssl_decrypt($_POST['iddoce'],AES,KEY);

         $iddocente1 = mysqli_real_escape_string($con,$iddocente);

         $query_delete = $con->prepare("UPDATE docentes set estatus = 0 where id= ?");
         $query_delete->bind_param("i",$iddocente1);
         ...
         if($query_delete){
            ...
            $mensaje =  '<script>
                           ...
                           icon: "Error",
                           title: "Oops...",
                           text: "Error al eliminar el Docente - Comuniquese con el administrador!"
                                 });
                        </script>';
         }
      }
...
<?php
    ...
    $iddoce = openssl_decrypt($_GET['id'],AES,KEY);

    $query_consulta = mysqli_query($con, "SELECT * from docentes where id = $iddoce and estatus=1");
    ...
    $query = mysqli_query($con, "SELECT id, ayn, dni from docentes where id = $iddoce");
    mysqli_close($con);
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="block block-themed">
                            <div class="block-header bg-gd-emerald">
                                <h3 class="block-title">Eliminar Docente</h3>
                            </div>
                            <div class="block-content text-center">
                              ...
                              <div class="">
                                   ...
                                   <hr>
                                   <p>ID: <span><?php echo $iddoce;?></span></p>
                                   <p>DNI: <span><?php echo $dni;?></span></p>
                                   <p>Docente: <span><?php echo $nombre;?></span></p>

                                   <form method="post" action="">
                                     <input type="hidden" name="iddoce" value="<?php echo openssl_encrypt($iddoce,AES,KEY);?>">
                                     <a href="listado_docentes.php" class="btn btn-success"><i class="fas fa-ban"></i> Cancelar</a>
